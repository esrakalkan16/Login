...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PCONTDEVTYPE
    {
        public int COMPANYID { get; set; }
        public int PCONTDEVTYPEID { get; set; }
        public string PCONTDEVTYPETYPENAME { get; set; }
        public Nullable<short> PCONTDEVTYPETYPE { get; set; }
        public string PCONTDEVTYPENO { get; set; }
        public string PCONTDEVTYPENAME { get; set; }
