...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PROUTE
    {
        public int COMPANYID { get; set; }
        public int PROUTEID { get; set; }
        public string PROUTETYPENAME { get; set; }
        public Nullable<short> PROUTETYPE { get; set; }
        public string PROUTENO { get; set; }
        public string PROUTENAME { get; set; }
