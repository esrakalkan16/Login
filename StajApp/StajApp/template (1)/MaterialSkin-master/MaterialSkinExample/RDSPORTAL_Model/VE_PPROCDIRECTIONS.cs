...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PPROCDIRECTIONS
    {
        public int COMPANYID { get; set; }
        public int PPROCDIRECTIONSID { get; set; }
        public string PPROCDIRECTIONSNO { get; set; }
        public string PPROCDIRECTIONSNAME { get; set; }
        public string PPROCDIRECTIONSTYPENAME { get; set; }
        public Nullable<int> PPROCDIRECTIONSTYPE { get; set; }
