...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_TREXPRG
    {
        public int COMPANYID { get; set; }
        public int TREXPRGID { get; set; }
        public string TREXPRGTYPENAME { get; set; }
        public Nullable<short> TREXPRGTYPE { get; set; }
        public string TREXPRGNO { get; set; }
        public string TREXPRGNAME { get; set; }
