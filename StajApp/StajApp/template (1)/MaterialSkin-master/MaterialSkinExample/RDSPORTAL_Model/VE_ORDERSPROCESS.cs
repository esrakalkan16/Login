...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_ORDERSPROCESS
    {
        public int COMPANYID { get; set; }
        public int ORDERSPROCESSID { get; set; }
        public string ORDERSPROCESSTYPENAME { get; set; }
        public Nullable<short> ORDERSPROCESSTYPE { get; set; }
        public string ORDERSPROCESSNO { get; set; }
        public string ORDERSPROCESSNAME { get; set; }
