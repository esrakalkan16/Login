...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PFURNITUREMOD
    {
        public int COMPANYID { get; set; }
        public int PFURNITUREMODID { get; set; }
        public string PFURNITUREMODTYPENAME { get; set; }
        public Nullable<short> PFURNITUREMODTYPE { get; set; }
        public string PFURNITUREMODNO { get; set; }
        public string PFURNITUREMODNAME { get; set; }
