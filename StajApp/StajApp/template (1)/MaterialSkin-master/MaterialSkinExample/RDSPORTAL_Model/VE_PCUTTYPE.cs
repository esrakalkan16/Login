...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PCUTTYPE
    {
        public int COMPANYID { get; set; }
        public int PCUTTYPEID { get; set; }
        public string PCUTTYPENO { get; set; }
        public string PCUTTYPENAME { get; set; }
        public string PCUTTYPETYPENAME { get; set; }
        public Nullable<int> PCUTTYPETYPE { get; set; }
