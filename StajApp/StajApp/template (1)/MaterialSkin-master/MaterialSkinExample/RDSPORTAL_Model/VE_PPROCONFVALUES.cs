...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PPROCONFVALUES
    {
        ...
        public Nullable<double> FIELDVALUEF { get; set; }
        public Nullable<int> FIELDVALUEI { get; set; }
        public Nullable<bool> FIELDVALUEB { get; set; }
