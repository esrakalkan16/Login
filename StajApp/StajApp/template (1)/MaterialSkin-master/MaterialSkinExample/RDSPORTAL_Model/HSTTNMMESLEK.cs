...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class HSTTNMMESLEK
    {
        public int COMPANYID { get; set; }
        public int HSTTNMMESLEKID { get; set; }
        public Nullable<short> HSTTNMMESLEKTYPE { get; set; }
        public string HSTTNMMESLEKNO { get; set; }
        public string HSTTNMMESLEKNAME { get; set; }
