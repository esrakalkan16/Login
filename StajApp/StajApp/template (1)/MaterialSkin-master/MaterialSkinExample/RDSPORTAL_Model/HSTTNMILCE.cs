...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class HSTTNMILCE
    {
        public int COMPANYID { get; set; }
        public int HSTTNMILCEID { get; set; }
        public Nullable<short> HSTTNMILCETYPE { get; set; }
        public string HSTTNMILCENO { get; set; }
        public string HSTTNMILCENAME { get; set; }
