...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PJOBCLOSECAUSE
    {
        public int COMPANYID { get; set; }
        public int PJOBCLOSECAUSEID { get; set; }
        public string PJOBCLOSECAUSETYPENAME { get; set; }
        public Nullable<short> PJOBCLOSECAUSETYPE { get; set; }
