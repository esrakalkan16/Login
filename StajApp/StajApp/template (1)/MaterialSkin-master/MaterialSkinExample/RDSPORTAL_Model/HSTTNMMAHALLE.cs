...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class HSTTNMMAHALLE
    {
        public int COMPANYID { get; set; }
        public int HSTTNMMAHALLEID { get; set; }
        public Nullable<short> HSTTNMMAHALLETYPE { get; set; }
        public string HSTTNMMAHALLENO { get; set; }
        public string HSTTNMMAHALLENAME { get; set; }
