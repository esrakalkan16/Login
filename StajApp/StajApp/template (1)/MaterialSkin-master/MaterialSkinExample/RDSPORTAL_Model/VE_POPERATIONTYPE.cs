...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_POPERATIONTYPE
    {
        public int COMPANYID { get; set; }
        public int POPERATIONTYPEID { get; set; }
        public string POPERATIONTYPENO { get; set; }
        public string POPERATIONTYPENAME { get; set; }
        public string POPERATIONTYPETYPENAME { get; set; }
        public Nullable<short> POPERATIONTYPETYPE { get; set; }
