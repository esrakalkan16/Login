...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_DEPARTMAN
    {
        public int COMPANYID { get; set; }
        public int DEPARTMANID { get; set; }
        public string DEPARTMANTYPENAME { get; set; }
        public Nullable<short> DEPARTMANTYPE { get; set; }
        ...
        public Nullable<short> APPROVESTEP { get; set; }
