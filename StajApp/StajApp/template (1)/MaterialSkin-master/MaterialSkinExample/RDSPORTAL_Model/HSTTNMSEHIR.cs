...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class HSTTNMSEHIR
    {
        public int COMPANYID { get; set; }
        public int HSTTNMSEHIRID { get; set; }
        public Nullable<short> HSTTNMSEHIRTYPE { get; set; }
        public string HSTTNMSEHIRNO { get; set; }
        public string HSTTNMSEHIRNAME { get; set; }
