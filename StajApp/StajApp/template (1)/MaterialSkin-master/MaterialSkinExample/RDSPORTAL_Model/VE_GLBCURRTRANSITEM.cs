...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_GLBCURRTRANSITEM
    {
        public string CURRCODE { get; set; }
        public System.DateTime CURRDATE { get; set; }
        public int ITEMNO { get; set; }
        public Nullable<double> CURRBUY { get; set; }
        public Nullable<double> CURRSELL { get; set; }
        public Nullable<double> CURREFFBUY { get; set; }
        public Nullable<double> CURREFFSELL { get; set; }
