...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PINPCONTDEFSTA
    {
        public int COMPANYID { get; set; }
        public int PINPCONTDEFSTAID { get; set; }
        public string PINPCONTDEFSTATYPENAME { get; set; }
        public Nullable<short> PINPCONTDEFSTATYPE { get; set; }
        public string PINPCONTDEFSTANO { get; set; }
        public string PINPCONTDEFSTANAME { get; set; }
        public string PINPACCEPTTYPENAME { get; set; }
        public Nullable<int> PINPACCEPTTYPE { get; set; }
