...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class HSTTNMUNITE
    {
        public int COMPANYID { get; set; }
        public int HSTTNMUNITEID { get; set; }
        public Nullable<short> HSTTNMUNITETYPE { get; set; }
        public string HSTTNMUNITENO { get; set; }
        public string HSTTNMUNITENAME { get; set; }
        ...
        public Nullable<short> YATAKSAYISI { get; set; }
