...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_PNEWPRODPROC
    {
        public int COMPANYID { get; set; }
        public int PNEWPRODRECID { get; set; }
        public int ITEMNO { get; set; }
        public string PNEWPRODPROCESSNO { get; set; }
        public string PNEWPRODPROCESSNAME { get; set; }
        public string PNEWPRODPROCESSTYPE { get; set; }
        public int PNEWPRODPROCESSID { get; set; }
        public Nullable<System.DateTime> PLANDATE { get; set; }
        public Nullable<System.DateTime> FINISHDATE { get; set; }
        public Nullable<int> STATUSPROS { get; set; }
