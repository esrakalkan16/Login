...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class HSTTNMKOY
    {
        public int COMPANYID { get; set; }
        public int HSTTNMKOYID { get; set; }
        public Nullable<short> HSTTNMKOYTYPE { get; set; }
        public string HSTTNMKOYNO { get; set; }
        public string HSTTNMKOYNAME { get; set; }
