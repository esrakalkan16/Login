...
namespace StajApp.template (1).MaterialSkin-master.MaterialSkinExample.RDSPORTAL_Model
{
    ...
    public partial class VE_TREXMODULSADD
    {
        public int COMPANYID { get; set; }
        public int TREXMODULSID { get; set; }
        public string TREXMODULSTYPENAME { get; set; }
        public Nullable<short> TREXMODULSTYPE { get; set; }
        public string TREXMODULSNAME { get; set; }
        public Nullable<double> SERIALNO { get; set; }
